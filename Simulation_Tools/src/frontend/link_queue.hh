...
private:
    ...
    /* Virtual Driver Queue additions */
    std::deque<QueuedPacket> driver_queue_;
    const static unsigned int MAX_DRIVER_QUEUE_SIZE = 128;
    void try_move_packets( void );
    /* End Virtual Driver Queue additions */
